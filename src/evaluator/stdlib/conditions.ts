...
export const _if: AnnotationFunction = function (value, rawArgs, context) {
...
export const _switch: AnnotationFunction = function (value, args, context) {
...
export const cond: AnnotationFunction = function (value, args, context) {
  assertArgumentTypes(args, []);
